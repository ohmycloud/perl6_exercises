...
### I should probably end up grouping all of these into Building/Callable.pm 
### and Building/Basic.pm and Building/SS.pm or some such.
### But if I do that, I'll need to be careful about naming them because of the 
### EVAL.
###
### In the meantime, here is OK.
class Games::Lacuna::Model::Building::planetarycommand does Games::Lacuna::Model::Building::BuildingRole {#{{{
    method view() {
...
class Games::Lacuna::Model::Building::OwnBuilding does Games::Lacuna::Model::Building::BuildingRole {#{{{
    ...
    method object() {
        ...
        return EVAL 'Games::Lacuna::Model::Building::' ~ $.type ~ '.new( :$.account, :%.json )';
    }
